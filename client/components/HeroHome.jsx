        ...
        <div className="pt-32 pb-12 md:pt-40 md:pb-20">
          ...
          <div className="text-center pb-12 md:pb-16">
            ...
            <div className="max-w-3xl mx-auto">
              <p
                className="text-xl text-primary-content mb-8"
                data-aos="zoom-y-out"
                data-aos-delay="150"
              >
              ...
              >
                <div>
                  <a
                    className="text-white bg-blue-600 hover:bg-blue-700 w-full px-8 py-4 font-medium rounded-xl mr-5 "
                    href="#0"
                  >
                    Try Now !
                  </a>
                ...
                <div>
                  <a
                    className=" text-white bg-gray-900 hover:bg-gray-800 w-full px-8 py-4 font-medium rounded-xl "
                    href="#0"
                  >
                    Learn more
                  </a>
