...
contract NFTMARKETPLACE is ERC721URIStorage {
      ...
      uint256 listingPrice = 0.0025 ether; //people have to pay to list their nft
      ...
      function resellToken(uint256 tokenId ,uint256 price) public payable{
            require(idToMarketItem[tokenId].owner == msg.sender,"Owner can resell his own NFT");
            require(msg.value == listingPrice ,"Please pay a listing price before reselling");
      ...
      function cancelNFTsell(uint256 tokenId) public {
            require(idToMarketItem[tokenId].seller == msg.sender,"Seller can cancel his own NFT");
            require(idToMarketItem[tokenId].sold == false,"You can cancel only if you listed it for sell");
            idToMarketItem[tokenId].owner = payable(msg.sender);
            idToMarketItem[tokenId].sold = true;
            idToMarketItem[tokenId].seller = payable(address(0));
            _itemsold.increment();
